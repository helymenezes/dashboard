...
def base_oem_2t_mt():
    ...
    def reader_data():
       ...
       bd = bd.loc[(bd['ROTA'].isin([501,502,503,504,508,509,511]))]
    ...
    def reader_data_ins():
         ...
         del_rota = [599,600]
         bd_ins = pd.read_excel(r"C:\Users\OneEngInst\Projetos_python\dashboard\content\base_sip_instalacoes_Geral_mt.xlsx")
         ...
         bd_ins = bd_ins.loc[(bd_ins['ROTA'].isin([501,502,503,504,508,509,511]))]
